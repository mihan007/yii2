...
curl -vs -X POST \
  ...
  -H 'Authorization: Bearer ya29.Glu4BrgtNUMpjnJVxXauZme6oRsz6tBBKzB3VDKgtJsiFzsmes6_1Ajyhw9n5RLZ00uPxLG85hktl561DLbYQfQ-GMAVJnUBAzNSh6671jCy5GEGPoPF4N37nQZJ' \
  ...
  -H 'cache-control: no-cache' \
  -d '<?xml version="1.0" encoding="UTF-8"?><soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soapenv:Header><ns1:RequestHeader soapenv:mustUnderstand="0" xmlns:ns1="https://adwords.google.com/api/adwords/cm/v201809"><ns1:clientCustomerId>801-426-1966</ns1:clientCustomerId><ns1:developerToken></ns1:developerToken><ns1:userAgent>unknown (AwApi-Java, AdWords-Axis/4.4.0, Common-Java/4.4.0, Axis/1.4, Java/1.8.0_181, maven, SelectorBuilder, SelectorField)</ns1:userAgent><ns1:validateOnly>false</ns1:validateOnly><ns1:partialFailure>false</ns1:partialFailure></ns1:RequestHeader></soapenv:Header><soapenv:Body><get xmlns="https://adwords.google.com/api/adwords/cm/v201809"><serviceSelector><fields>Id</fields><fields>Name</fields><ordering><field>Name</field><sortOrder>ASCENDING</sortOrder></ordering><paging><startIndex>0</startIndex><numberResults>100</numberResults></paging></serviceSelector></get></soapenv:Body></soapenv:Envelope>
